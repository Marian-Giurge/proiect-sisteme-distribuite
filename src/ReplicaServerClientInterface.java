...
public interface ReplicaServerClientInterface extends ReplicaInterface {
	 ...
	 * @throws RemoteException
	 */
	public ChunkAck write(long txnID, long msgSeqNum, FileContent data) throws RemoteException, IOException;
	 ...
	 * @throws IOException 
	 */
	public boolean commit(long txnID, long numOfMsgs) throws MessageNotFoundException, RemoteException, IOException;
